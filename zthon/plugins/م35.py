...
ZelzalDV_cmd = (
    "𓆩 [𝙎𝙊𝙐𝙍𝘾𝙀 𝙏𝘼𝙍𝘽𝙊𝙐𝙉 - اوامر التبليغ لتطير القنوات ](t.me/ADXG25) 𓆪\n\n"
    " ⏎ اهلا بك في اوامر البلاغات\n"
    " ⏎لاستعمال الامر ⏎ 𐇮.بلاغ+ عدد البلاغات+ بلرد ع كود\n"
    "\n𓆩 [𐇮 •𝑬3𝒅𝑨𝒎• . 𝑻𝑨𝑹𝑩𝑶𝑼𝑵 ™⤶](t.me/W_X_E1) 𓆪"
    "\n𓆩 [𐇮 •Monzer• . 𝑻𝑨𝑹𝑩𝑶𝑼𝑵 ™⤶](t.me/Z_X_Z_B) 𓆪"
)
...
async def add_sudo_user(event):
    ...
    output += "**✾╎يتم الان اعـادة تشغيـل بـوت تربون  انتظـر 2-1 دقيقـه ▬▭ ...**"
...
async def _(event):  # sourcery no-metrics
    ...
    output = (
        result + "**✾╎يتم الان اعـادة تشغيـل بـوت تربون  انتظـر 2-1 دقيقـه ▬▭ ...**\n"
    )
    if errors != "":
        output += "\n**- خطــأ :**\n" + errors
